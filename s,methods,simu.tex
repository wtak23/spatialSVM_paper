...
\begin{figure}
	...
	\begin{subfigure}[b]{0.25\linewidth}
		 \centering
		 \resizebox{0.94\linewidth}{!}{\input{f,tikz,sim,connStruct,hc.tex}}
		 \caption{Control}
	...
	\begin{subfigure}[b]{0.5\linewidth}
		 \centering
		 \resizebox{0.94\linewidth}{!}{\input{f,tikz,sim,connStruct,ds.tex}}
		 \caption{Patient}
		 \label{subfig:sim,conn,struct,ds}
	\end{subfigure}
	\begin{subfigure}[b]{0.235\linewidth}
		 \centering
		 \raisebox{0pt}{\hspace{-8pt}\includegraphics[width=1.125\linewidth]{sim_weight_truth.pdf}}\vspace{-5pt}\\
